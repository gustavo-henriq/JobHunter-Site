...
export default function Explore() {
  ...
  return <main className="jx" ref={root}>
    ...
    <div className="jx-footer jx-wrap"><a className="jx-logo" href="#jx-main"><img className="jx-brand-mark" src="/job-hunter-encaixe.png" alt="" width="40" height="40" />jobhunter</a><a href="https://byguto.com" target="_blank" rel="noreferrer">byguto ↗</a></div>
  </main>;
}
